    ...
    <div class="container" id="main-container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-primary">
                <div class="panel-heading">
                  <h3 class="panel-title">Overhoring</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <span class="input-group-addon" id="basic-addon3">Antwoord</span>
                    ...
                    <div class="row">
                    <br />
                        <div class="btn-group col-md-6 col-md-offset-5" role="group">
                        <button type="button" class="btn btn-default">Volgende</button>
                        </div>
