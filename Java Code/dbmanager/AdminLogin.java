...
public class AdminLogin 
{
	...
	public static String getUsername()
	{
		...
		//Select statement
		try {
			PreparedStatement ps = connection.prepareStatement("SELECT GEBRUIKERSNAAM FROM ADMINISTRATOR");
	...
	public static String getPassword()
	{
		...
		try {
			PreparedStatement ps = connection.prepareStatement("SELECT WACHTWOORD FROM ADMINISTRATOR");
			ResultSet rs = ps.executeQuery();
